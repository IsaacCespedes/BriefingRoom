...
describe("Daily.co API", () => {
  ...
  describe("createRoom", () => {
    it("should create a room successfully", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(`${API_BASE_URL}/api/daily/create-room`, {
        method: "POST",
        headers: {
  ...
  describe("getRoomUrl", () => {
    it("should get room URL successfully", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(`${API_BASE_URL}/api/daily/room/${interviewId}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${mockToken}`,
